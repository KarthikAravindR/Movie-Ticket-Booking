...
const input = (props) => {
    ...
    switch (props.elementtype) {
        case 'input':
            ...
            break;
        case 'select':
            inputelement = <select onChange={props.changd} className={classes.Inputelement} {...props.elementconfig} value={props.value}>
    ...
    return (
        <div className={classes.Input}>
            ...
            {props.label === 'seats' && <p className={allclass.join(' ')}>*Only {props.availableseats} Seats available*</p>  }
        </div>
    )
}
